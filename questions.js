export let questions = [
  ...
  {
    letter: "k",
    answer: ["kamikaze", "karaoke", "kilo"],
    status: 0,
    question: [
      "CON LA K. Persona que se juega la vida realizando una acción temeraria",
      "CON LA K. Modalidad de entretenimiento en el que una persona canta canciones conocidas",
      "CON LA K. Medida de peso equivalente a mil gramos",
    ],
  },
  {
    letter: "l",
  ...
  },
  {
    ...
    question: [
      ...
      "CONTIENE LA W. Bebida alcohólica obtenida por la destilación de la malta fermentada de cereales",
      "CONTIENE LA W. Deporte que se practica sobre una tabla especial provista de una vela",
    ],
  },
  {
    letter: "x",
